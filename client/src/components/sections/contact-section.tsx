...
import { Mail, Linkedin, Github, MapPin, Phone, Send, CheckCircle, Loader2 } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className={`${isInView ? "animate-fade-in-up stagger-2" : "opacity-0"}`} style={{ animationFillMode: "forwards" }}>
              <Card>
                <CardContent className="p-6">
                  {isSubmitted ? (
                    <div className="flex flex-col items-center justify-center py-8 text-center" data-testid="contact-form-success">
